...
[assembly: ExportRenderer(typeof(FloatingFrameRound), typeof(MaterialRoundFrameRenderer))]
namespace MeetupSurvey.iOS.Renderers
{
    ...
    public class MaterialRoundFrameRenderer : FrameRenderer
    {
        public override void Draw(CGRect rect)
        {
            ...
            if (Element.HasShadow)
            {
                ...
                Layer.ShadowOffset = new CGSize(1, 3);
